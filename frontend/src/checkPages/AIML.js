      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical flex-1 ml-64 p-4 mt-32">
        <li>
          ...
          <div className="timeline-start md:text-end mb-10">
            ...
            <div className="text-lg font-black">Introduction to AIML</div>
        ...
        <li>
          ...
          <div className="timeline-end mb-10">
            ...
            <div className="text-lg font-black">Supervised Learning</div>
            Dive into supervised learning and regression models.
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-start md:text-end mb-10">
            ...
            <div className="text-lg font-black">Unsupervised Learning</div>
            Explore unsupervised learning and clustering algorithms.
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-end mb-10">
            ...
            <div className="text-lg font-black">Neural Networks</div>
        ...
        <li>
          ...
          <div className="timeline-start md:text-end mb-10">
            ...
            <div className="text-lg font-black">AI Model Implementation</div>
            Implement AI models and evaluate their performance.
          </div>
        </li>
      </ul>
    </div>
