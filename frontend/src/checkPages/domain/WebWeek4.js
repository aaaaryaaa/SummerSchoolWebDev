...
export default function WebWeek4({ user }) {
  ...
  const fetchWeek = async () => {
    const response = await fetch(BaseUrl + '/api/progress/webweek4')
  ...
  const fetchRecord = async () => {
    ...
    const response = await fetch(
      BaseUrl + '/api/progress/webweek4/' + user.phone_number
    )
    const json = await response.json()
      ...
      <div className="lg:col-span-9 ">
        {false ? (<>
          <div className="lg:mt-20 w-full">
            <h1 className=" text-center text-[#00CDB7] lg:text-6xl text-2xl relative top-14 py-10 font-bold">WEB WEEK 4</h1>
                        ...
                        <div className="bgfiltercard ml-6 w-full">
                          <a id="hide1" href="#hide1" className="hide">
                            <div className='flex justify-between align-middle'>
                              Open Task 1 : Asynchronous JS
                              <img src={arrowdownblack} alt=">" className='w-8 h-8' />
                            </div>
                          </a>
                          <a id="show1" href="#show1" className="show">
                            <div className='flex justify-between align-middle'>
                              Close Task 1 : Asynchronous JS
                              <img src={arrowupblack} alt="<" className='w-8 h-8' />
                            </div>
                          </a>
                          <div className="details">
                            <li><a href="https://www.youtube.com/playlist?list=PL4cUxeGkcC9jx2TTZk3IGWKSbtugYdrlu" target='_blank' className='text-[blue]'>Async Javascript</a></li>
                          </div>
                        </div>
                      </div>
                      <div className="form-control flex flex-row">
                        ...
                        <div className="bgfiltercard ml-6 w-full">
                          <a id="hide2" href="#hide2" className="hide">
                            <div className='flex justify-between align-middle'>
                              Open Task 2 : Week Submissions
                              <img src={arrowdownblack} alt=">" className='w-8 h-8' />
                            </div>
                          </a>
                          <a id="show2" href="#show2" className="show">
                            <div className='flex justify-between align-middle'>
                              Close Task 2 : Week Submissions
                              <img src={arrowupblack} alt="<" className='w-8 h-8' />
                            </div>
                          </a>
                          <div className="details">
                            Try any one :
                            <li><a href="https://www.frontendmentor.io/challenges/ip-address-tracker-I8-0yYAH0" target='_blank' className='text-[blue]'>Mini Proj 1</a></li>
                            <li><a href="https://www.frontendmentor.io/challenges/rest-countries-api-with-color-theme-switcher-5cacc469fec04111f7b848ca" target='_blank' className='text-[blue]'>Mini Proj 2</a></li>
                            {/* </div>
                      </div>
                    </div>
                    <div className="form-control flex flex-row">
