...
export default function AppWeek2({ user }) {
  ...
  const fetchWeek = async () => {
    const response = await fetch(BaseUrl + '/api/progress/appweek2')
  ...
  const fetchRecord = async () => {
    ...
    const response = await fetch(
      BaseUrl + '/api/progress/appweek2/' + user.phone_number
    )
    const json = await response.json()
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide1" href="#hide1" className="hide">
                                <div className="flex justify-between align-middle">
                                  Open Task 1 : Learn more about widgets in
                                  Flutter and their properties.
                                  <img
                                    src={arrowdownblack}
                                    alt=">"
                                    className="w-8 h-8"
                              ...
                              <a id="show1" href="#show1" className="show">
                                <div className="flex justify-between align-middle">
                                  Close Task 1 : Learn more about widgets in
                                  Flutter and their properties.
                                  <img
                                    src={arrowupblack}
                                    alt="<"
                          ...
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide2" href="#hide2" className="hide">
                                <div className="flex justify-between align-middle">
                                  Open Task 2 : Explore different widgets and
                                  how they can be used to make different
                                  designs.
                                  <img
                                    src={arrowdownblack}
                                    alt=">"
                              ...
                              <a id="show2" href="#show2" className="show">
                                <div className="flex justify-between align-middle">
                                  Close Task 2 : Explore different widgets and
                                  how they can be used to make different
                                  designs.
                                  <img
                                    src={arrowupblack}
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              ...
                              <div className="details">
                                <ul>
                                  ...
                                  <li>
                                    Task: Develop a multi-screen app that
                                    showcases a list of contact cards with a
                                  ...
                                  <li>
                                    ...
                                    <li>
                                      <li>
                                        1.Implement different layout widgets
                                        such as Row, Column, and Stack to design
                                        the main screen.
                                      </li>
                                      <li>
                                        2. Use navigation and routing to move
                                        between the home screen and the contact
                                        detail screen.
                                      </li>
                                      <li>
                                        3. Implement basic state management to
                                        handle user interactions like tapping on
                                        an contact to view details.
                                      </li>
                                      <li>
                                        4. Ensure the app has a responsive
                                        design using layout widgets effectively.
                                      </li>
                                    </li>
                                  </li>
                                </ul>
