...
export default function DesignWeek1({ user }) {
  ...
  const fetchWeek = async () => {
    const response = await fetch(BaseUrl + '/api/progress/designweek1')
  ...
  const fetchRecord = async () => {
    ...
    const response = await fetch(
      BaseUrl + '/api/progress/designweek1/' + user.phone_number
    )
    const json = await response.json()
                    ...
                    <div className="grid gap-4 w-full">
                      ...
                      <div className="form-control flex flex-row">
                        ...
                        <div className="bgfiltercard ml-6 w-full">
                          ...
                          <div className="details">
                            Make a trailer about any media content of your
                            choice, maybe a favourite movie or show, which
                            should be atleast one minute long.
                          </div>
                        </div>
                      </div>
                      <div className="form-control flex flex-row">
