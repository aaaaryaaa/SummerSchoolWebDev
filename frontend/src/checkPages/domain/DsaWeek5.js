...
export default function DsaWeek5({ user }) {
  ...
  const fetchWeek = async () => {
    const response = await fetch(BaseUrl + '/api/progress/dsaweek5')
  ...
  const fetchRecord = async () => {
    ...
    const response = await fetch(
      BaseUrl + '/api/progress/dsaweek5/' + user.phone_number
    )
    const json = await response.json()
    ...
    <div className="lg:grid lg:grid-cols-10 w-full">
      ...
      <div className="lg:col-span-9 ">
        <div className="lg:mt-20 w-full">
          <h1 className=" text-center text-[#00CDB7] lg:text-6xl text-2xl relative top-14 py-10 font-bold">DSA WEEK 5</h1>
