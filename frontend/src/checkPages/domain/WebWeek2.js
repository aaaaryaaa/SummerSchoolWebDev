...
export default function WebWeek2({ user }) {
  ...
  const fetchWeek = async () => {
    const response = await fetch(BaseUrl + '/api/progress/webweek2')
  ...
  const fetchRecord = async () => {
    ...
    const response = await fetch(
      BaseUrl + '/api/progress/webweek2/' + user.phone_number
    )
    const json = await response.json()
          ...
          {false ? (
            <>
              <div className="lg:mt-20 w-full">
                <h1 className=" text-center text-[#00CDB7] lg:text-6xl text-2xl relative top-14 py-10 font-bold">WEB WEEK 2</h1>
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide1" href="#hide1" className="hide">
                                <div className='flex justify-between align-middle'>
                                  Open Task 1 : CSS Grid
                                  <img src={arrowdownblack} alt=">" className='w-8 h-8' />
                                </div>
                              </a>
                              <a id="show1" href="#show1" className="show">
                                <div className='flex justify-between align-middle'>
                                  Close Task 1 : CSS Grid
                                  <img src={arrowupblack} alt="<" className='w-8 h-8' />
                                </div>
                              </a>
                              <div className="details">
                                <li>CSS Grid- Net Ninja <a href="https://www.youtube.com/playlist?list=PL4cUxeGkcC9itC4TxYMzFCfveyutyPOCY" target='_blank' className='text-[blue]'>CSS Grid</a></li>
                                <li>CSS Grid Crash COurse - Traversy Media <a href="https://youtu.be/jV8B24rSN5o?si=IkgVe7dU8FJ3ZMgE" target='_blank' className='text-[blue]'>CSS Grid Crash Course</a></li>
                              </div>
                            </div>
                          </div>
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide2" href="#hide2" className="hide">
                                <div className='flex justify-between align-middle'>
                                  Open Task 2 : Media Queries
                                  <img src={arrowdownblack} alt=">" className='w-8 h-8' />
                                </div>
                              </a>
                              <a id="show2" href="#show2" className="show">
                                <div className='flex justify-between align-middle'>
                                  Close Task 2 : Media Queries
                                  <img src={arrowupblack} alt="<" className='w-8 h-8' />
                                </div>
                              </a>
                              <div className="details">
                                <li>Media Queries Simplfied: <a href="https://youtu.be/yU7jJ3NbPdA?si=kur7e2aQDxc1gKxO" target='_blank' className='text-[blue]'>Media Queries</a></li>
                              </div>
                            </div>
                          </div>
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide3" href="#hide3" className="hide">
                                <div className='flex justify-between align-middle'>
                                  Open Task 3 : CSS Animations
                                  <img src={arrowdownblack} alt=">" className='w-8 h-8' />
                                </div>
                              </a>
                              <a id="show3" href="#show3" className="show">
                                <div className='flex justify-between align-middle'>
                                  Close Task 3 : CSS Animations
                                  <img src={arrowupblack} alt="<" className='w-8 h-8' />
                                </div>
                              </a>
                              <div className="details">
                                <li>Video for CSS Animation: <a href="https://www.youtube.com/playlist?list=PL4cUxeGkcC9iGYgmEd2dm3zAKzyCGDtM5" target='_blank' className='text-[blue]'>CSS Animation</a></li>
                              </div>
                            </div>
                          </div>
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide4" href="#hide4" className="hide">
                                <div className='flex justify-between align-middle'>
                                  Open Task 4 : Tailwind CSS
                                  <img src={arrowdownblack} alt=">" className='w-8 h-8' />
                                </div>
                              </a>
                              <a id="show4" href="#show4" className="show">
                                <div className='flex justify-between align-middle'>
                                  Close Task 4 : Tailwind CSS
                                  <img src={arrowupblack} alt="<" className='w-8 h-8' />
                                </div>
                              </a>
                              <div className="details">
                                <li>Tailwind CSS in detail : <a href="https://youtu.be/ft30zcMlFao?si=0G-iPEVoGnjlOswB" target='_blank' className='text-[blue]'>Detailed Tailwind</a></li>
                                <li>Tailwind CSS Crash Course by Traversy Media <a href="https://youtu.be/dFgzHOX84xQ?si=3I1r_h0kGZ6KLyhG" target='_blank' className='text-[blue]'>Tailwind Crash Course</a></li>
                              </div>
                            </div>
                          </div>
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide5" href="#hide5" className="hide">
                                <div className='flex justify-between align-middle'>
                                  Open Task 5 : Bootstrap (Optional)
                                  <img src={arrowdownblack} alt=">" className='w-8 h-8' />
                                </div>
                              </a>
                              <a id="show5" href="#show5" className="show">
                                <div className='flex justify-between align-middle'>
                                  Close Task 5 : Bootstrap (Optional)
                                  <img src={arrowupblack} alt="<" className='w-8 h-8' />
                                </div>
                              </a>
                              <div className="details">
                                Bootstrap Crash Course by Traversy Media: <a href="https://youtu.be/4sosXZsdy-s?si=PWgOpvYTS3lmdz7u" target='_blank' className='text-[blue]'>Bootstrap</a>
                              </div>
                            </div>
                          </div>
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              ...
                              <div className="details">
                                Any one of the two Mini Projects:
                                <li>E-comerce Website</li>
