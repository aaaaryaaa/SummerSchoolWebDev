                          ...
                          <div className="grid gap-4 w-full">
                              ...
                              <div className="bgfiltercard ml-6 w-full">
                                ...
                                <div className="details">
                                  <li>
                                    CSS Grid- Net Ninja{' '}
                                    <a
                                      href="https://www.youtube.com/playlist?list=PL4cUxeGkcC9itC4TxYMzFCfveyutyPOCY"
                                      target="_blank"
                                      className="text-[blue]"
                                    >
                                      CSS Grid
                                  ...
                                  <li>
                                    ...
                                    <a
                                      href="https://youtu.be/jV8B24rSN5o?si=IkgVe7dU8FJ3ZMgE"
                                      target="_blank"
                                      className="text-[blue]"
                                    >
                            ...
                            <div className="form-control flex flex-row">
                              ...
                              <div className="bgfiltercard ml-6 w-full">
                                ...
                                <div className="details">
                                  <li>
                                    Media Queries Simplfied:{' '}
                                    <a
                                      href="https://youtu.be/yU7jJ3NbPdA?si=kur7e2aQDxc1gKxO"
                                      target="_blank"
                                      className="text-[blue]"
                                    >
                                      Media Queries
                            ...
                            <div className="form-control flex flex-row">
                              ...
                              <div className="bgfiltercard ml-6 w-full">
                                ...
                                <div className="details">
                                  <li>
                                    Tailwind CSS in detail :{' '}
                                    <a
                                      href="https://youtu.be/ft30zcMlFao?si=0G-iPEVoGnjlOswB"
                                      target="_blank"
                                      className="text-[blue]"
                                    >
                                      Detailed Tailwind
                                  ...
                                  <li>
                                    ...
                                    <a
                                      href="https://youtu.be/dFgzHOX84xQ?si=3I1r_h0kGZ6KLyhG"
                                      target="_blank"
                                      className="text-[blue]"
                                    >
                            ...
                            <div className="form-control flex flex-row">
                              ...
                              <div className="bgfiltercard ml-6 w-full">
                                ...
                                <div className="details">
                                  Bootstrap Crash Course by Traversy Media:{' '}
                                  <a
                                    href="https://youtu.be/4sosXZsdy-s?si=PWgOpvYTS3lmdz7u"
                                    target="_blank"
                                    className="text-[blue]"
                                  >
                                    Bootstrap
