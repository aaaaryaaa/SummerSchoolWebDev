      ...
      <div className="lg:col-span-9 ">
        {false ? (<>
          <div className="lg:mt-20 w-full">
            <h1 className=" text-center text-[#00CDB7] lg:text-6xl text-2xl relative top-14 py-10 font-bold">WEB WEEK 3</h1>
                    ...
                    <div className="grid gap-4 w-full">
                      <div className="form-control flex flex-row w-full">
                        ...
                        <div className="bgfiltercard ml-6 w-full">
                          ...
                          <div className="details">
                            <li><a href="https://youtu.be/PkZNo7MFNFg?si=P_dbyKD8DZTTldQU" target='_blank' className='text-[blue]'>Full JS Course</a></li>
                          </div>
                        </div>
                      </div>
                      <div className="form-control flex flex-row">
                        ...
                        <div className="bgfiltercard ml-6 w-full">
                          ...
                          <div className="details">
                            <li><a href="https://www.youtube.com/playlist?list=PL4cUxeGkcC9gfoKa5la9dsdCNpuey2s-V" target='_blank' className='text-[blue]'>JS DOM Tutorial</a></li>
                          </div>
                        </div>
                      </div>
                      <div className="form-control flex flex-row">
                        ...
                        <div className="bgfiltercard ml-6 w-full">
                          ...
                          <div className="details">
                            <li><a href="https://www.youtube.com/playlist?list=PL4cUxeGkcC9i5yvDkJgt60vNVWffpblB7" target='_blank' className='text-[blue]'>Object Oriented JS</a></li>
                          </div>
                        </div>
                      </div>
                      <div className="form-control flex flex-row">
                        ...
                        <div className="bgfiltercard ml-6 w-full">
                          ...
                          <div className="details">
                            Try any one:
                            <li><a href="https://www.frontendmentor.io/challenges/rock-paper-scissors-game-pTgwgvgH" target='_blank' className='text-[blue]'>Mini Project 1</a></li>
                            <li><a href="https://www.frontendmentor.io/challenges/pomodoro-app-KBFnycJ6G" target='_blank' className='text-[blue]'>Mini project 2</a></li>
                            {/* </div>
                      </div>
                    </div>
                    <div className="form-control flex flex-row">
