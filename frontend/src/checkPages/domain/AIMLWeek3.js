                          ...
                          <div className="form-control flex flex-row w-full">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              ...
                              <div className="details">
                                Access or audit the course below, and complete
                                week1 and week2 - <br />
                                <a
                          ...
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              ...
                              <a id="show2" href="#show2" className="show">
                                <div className="flex justify-between align-middle">
                                  Close Task 2 : Implementation without
                                  libraries
                                  <img
                                    src={arrowupblack}
                                    alt="<"
                          ...
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide3" href="#hide3" className="hide">
                                <div className="flex justify-between align-middle">
                                  Open Assignment : Apply Linear Regression on a
                                  given Dataset.
                                  <img
                                    src={arrowdownblack}
                                    alt=">"
                              ...
                              <a id="show3" href="#show3" className="show">
                                <div className="flex justify-between align-middle">
                                  Close Assignment : Apply Linear Regression on
                                  a given Dataset.
                                  <img
                                    src={arrowupblack}
                                    alt="<"
                              ...
                              <div className="details">
                                Complete the task of applying Linear Regression
                                on the dataset below and upload your work on
                                github <br />
                                <a
