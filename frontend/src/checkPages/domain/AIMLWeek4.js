                        ...
                        <div className="grid gap-4 w-full">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              <a id="hide1" href="#hide1" className="hide">
                                <div className="flex justify-between align-middle">
                                  Open Task 1 : Logistic Regression, Support
                                  Vector Machine, Multiclass Prediction
                                  <img
                                    src={arrowdownblack}
                                    alt=">"
                                    className="w-8 h-8"
                              ...
                              <a id="show1" href="#show1" className="show">
                                <div className="flex justify-between align-middle">
                                  Close Task 1 : Logistic Regression, Support
                                  Vector Machine, Multiclass Prediction
                                  <img
                                    src={arrowupblack}
                                    alt="<"
                              ...
                              <div className="details">
                                Finish week 4 of the course given below and
                                submit the links to the assignments on github.{' '}
                                <br />
                                <a
                          ...
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              ...
                              <div className="details">
                                Finish week 3 of the course given below and
                                submit the links to the assignments on github.{' '}
                                <br />
                                <a
                          ...
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              ...
                              <div className="details">
                                Apply the above algorithms on the dataset given
                                below. Upload to github once completed.
                                <br />
                                <a
                          ...
                          <div className="form-control flex flex-row">
                            ...
                            <div className="bgfiltercard ml-6 w-full">
                              ...
                              <div className="details">
                                Find a Dataset (you can also find image or audio
                                data as well) of your own and apply the
                                algorithms that you all have learnt during the
                                summer school
                                <br />
                                Congratulations! You have completed the AIML
                                course.
                              </div>
                            </div>
                          </div>
